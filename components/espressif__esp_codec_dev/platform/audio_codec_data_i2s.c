    ...
    switch (channel_info.mode) {
        ...
        case I2S_COMM_MODE_PDM: {
            if (playback == false) {
                ...
                i2s_pdm_tx_clk_config_t clk_cfg = I2S_PDM_TX_CLK_DAC_DEFAULT_CONFIG(fs->sample_rate);
                i2s_pdm_tx_slot_config_t slot_cfg = I2S_PDM_TX_SLOT_DAC_DEFAULT_CONFIG(slot_bits, I2S_SLOT_MODE_STEREO);
