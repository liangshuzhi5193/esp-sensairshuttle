...
/**
 * @file common.h
 * @brief Common interface definitions for BMI270 sensor driver
 * 
 * This header file provides common interface functions and utilities
 * for the BMI270 sensor driver. It includes I2C/SPI communication
 * functions, delay utilities, and error handling functions that are
 * shared across different BMI270 driver implementations.
 * 
 * Key features:
 * - I2C and SPI communication interfaces
 * - Platform-independent delay functions
 * - Error code handling and reporting
 * - Interface initialization utilities
 * 
 * @note This file provides the common interface layer that abstracts
 *       hardware-specific communication details from the main driver.
 */

#ifndef _BMI270_COMMON_H
#define _BMI270_COMMON_H
