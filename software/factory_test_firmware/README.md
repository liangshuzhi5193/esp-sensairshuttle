...
- 提供 **BME680** 传感器子板与 **BMI270 + BMM350** 传感器子板接口，可测试传感器功能。

## 硬件需求
- ESP-SensairShuttle 开发板
- LCD 触摸显示屏，分辨率为284x240
- BME680 传感器子板和 BMI270 + BMM350 传感器子板
- 模拟麦克风与扬声器
...
6. **BME680 传感器测试**：确保开发板已经接入了 **BME680 传感器子板**。程序将自动读取 BME680 传感器的环境数据（温度、湿度、气压、气体电阻）。若传感器能够正常读取数据且数据范围正常，则程序将自动判断通过。
